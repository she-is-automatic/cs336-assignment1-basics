...
from cs336_basics.model import Linear, Embedding, RMSNorm, silu, SwiGLU, RoPE, scaled_dot_product_attention, CausalMHSA, TransformerBlock, TransformerLM
...
def run_multihead_self_attention_with_rope(
    ...
    mhsa = CausalMHSA(d_model, num_heads, rope)
    mhsa.q_proj.weight.data = q_proj_weight
    mhsa.k_proj.weight.data = k_proj_weight
    mhsa.v_proj.weight.data = v_proj_weight
    mhsa.output_proj.weight.data = o_proj_weight
